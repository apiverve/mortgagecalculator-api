...
{
    class MortgageCalculatorExample
    {
        private static readonly string API_KEY = Environment.GetEnvironmentVariable("APIVERVE_API_KEY") ?? "YOUR_API_KEY_HERE";
        private static readonly string API_URL = "https://api.apiverve.com/v1/mortgagecalculator";

        /// <summary>
        /// Make a POST request to the Mortgage Calculator API
        /// </summary>
        static async Task<JsonDocument> CallMortgageCalculatorAPI()
        {
            try
            {
                ...
                // Request body
                var requestBody &#x3D; new { amount &#x3D; 570000, rate &#x3D; 6.8, years &#x3D; 30 };
        ...
        {
            Console.WriteLine("📤 Calling Mortgage Calculator API...\n");

            var result = await CallMortgageCalculatorAPI();
